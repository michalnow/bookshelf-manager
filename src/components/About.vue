...
<v-container>
 <div id="container">
  ...
  <div id="lewy" class='aboutCenterColumn'>
      ...
      <p><strong>Bookshelf Manager</strong> launched in March 2020.</p>
      ...
      <div id="srodek" class='aboutCenterColumn'>
        ...
        <p>In a nutshell, <strong>Bookshelf Manager</strong> is where book lovers call home.</p>
        <p>
      ...
      <div id="prawy" class='aboutRightColumn'>
        <ul>
          <li>
          <div class='aboutMetric'>90 million</div>
          MEMBERS
          </li>
          <hr>
          <li>
          <div class='aboutMetric'>2.6 billion</div>
          BOOKS ADDED
          </li>
          <hr>
          <li>
...
export default {
  ...
  data(){
    return {
        pictures: [
          { imageUrl: 'https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80', id: 'afajfjadfaadfa323' },
          { imageUrl: 'https://images.unsplash.com/photo-1525358180237-7399f908a1d9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60', id: 'aadsfhbkhlk1241'}
        ]
      }
    }
  }
